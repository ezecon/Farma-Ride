...
export default function History() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div>
        {purchases
        .filter(purchase=>purchase.status==="Deliverd" && purchase.district===userInfo.district && purchase.division===userInfo.division && purchase.upazilas===userInfo.upazilas && purchase.rider === userID)
        .map((purchase) => (
