    ...
    <div className='bg-black'>
      ...
      <div className="flex-1 water-text text-center relative lg:left-[-20rem]">
        ...
        <div className="hidden md:flex lg:pr-56 lg:pt-2">
          <ul className="flex space-x-6">
            <li>
              <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="#home">
                Home
              </a>
            </li>
            <li>
              <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="#gallery">
                Gallery
              </a>
            </li>
            <li>
              <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="/players">
                Players
              </a>
            </li>
            <li>
              <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="/events">
                Events
              </a>
            </li>
            <li>
      ...
      {isMenuOpen && (
        <div className="md:hidden flex flex-col space-y-2 px-4 py-2">
          <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="#home" onClick={toggleMenu}>
            Home
          </a>
          <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="#gallery" onClick={toggleMenu}>
            Gallery
          </a>
          <a className="text-[#ffffff] hover:underline hover:underline-offset-4" href="/players" onClick={toggleMenu}>
            Players
          </a>
