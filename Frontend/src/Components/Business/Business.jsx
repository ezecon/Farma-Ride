...
export default function Business() {
  return (
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row bg-white rounded-lg w-full py-10 px-5 md:px-20">
        {/* Image Section */}
        <div className="flex sm:w-full md:w-1/2 p-4">
          <img 
        ...
        {/* Text Section */}
        <div className="p-4 sm:w-full md:w-1/2 flex flex-col justify-center">
      ...
      <div className="flex flex-col md:flex-row bg-white rounded-lg w-full py-10 px-5 md:px-20">
        ...
        <div className="p-4 sm:w-full md:w-1/2 flex flex-col justify-center">
          <p className="text-black montserrat-alternates-extralight">
            Want to run your business online? Big chance to engage in the online world. Let's explore. So, why waiting?
          </p>
          <a href="/role"><Button className="bg-black px-2 rounded-2xl mt-2">Get Started</Button></a>
        </div>
        {/* Image Section */}
